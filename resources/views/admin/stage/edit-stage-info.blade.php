...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('AdminLTE/company/stageinfo/edit/stageinfo.css') }}">
@endsection
...
@section('js')
    ...
    <script src="{{ asset('AdminLTE/company/stageinfo/edit/stageinfo.js') }}"></script>
@endsection
