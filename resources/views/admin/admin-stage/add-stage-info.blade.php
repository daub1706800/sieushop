...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('AdminLTE/admin/stage-info/add/stage-info.css') }}">
@endsection
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 row">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.stage-info.render-add') }}" class="btn btn-primary float-right add-work"><i class="fas fa-plus"></i></a>
                    </div>
                </div>
                <div class="col-md-12">
...
@section('js')
    ...
    <script src="{{ asset('AdminLTE/admin/stage-info/add/stage-info.js') }}"></script>
@endsection
