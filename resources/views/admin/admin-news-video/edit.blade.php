...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('admin.video.update', ['id' => $newsvideo->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control company-selected @error('idcongty') is-invalid @enderror" name="idcongty">
                                    ...
                                    @foreach($companies as $company)
                                        <option {{ $newsvideo->idchuyenmuc == $company->id ? "selected" : "" }} value="{{$company->id}}">{{$company->tencongty}}</option>
                                    @endforeach
                                </select>
                                @error('idcongty')
                                <div class="alert alert-danger alert-custom">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="{{ route('admin.video.remove', ['id' => $newsvideo->id]) }}">
                        ...
                        <form action="{{ route('admin.video.update-duyet', ['id' => $newsvideo->id]) }}">
                            <div class="d-flex justify-content-start">
                                <div class="form-group">
                        ...
                        <form action="{{ route('admin.video.update-xuatban', ['id' => $newsvideo->id]) }}">
                            <div class="d-flex justify-content-start">
                                <div class="form-group">
