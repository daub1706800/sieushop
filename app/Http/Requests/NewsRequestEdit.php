...
class NewsRequestEdit extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'hinhanhtintuc' => 'bail|nullable|mimes:jpeg,jpg,png|max:2048|dimensions:min_width=788, min_height=443',
            'videotintuc' => 'bail|nullable|mimes:mp4,mpeg,mov,avi|max:20480',
