...
class CompanyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'dienthoaicongty' => 'nullable|digits_between:8,16',
            'faxcongty' => 'nullable|digits_between:8,16',
    ...
    public function messages()
    {
        return [
            ...
            'dienthoaicongty.digits_between' => 'Điện thoại phải là kiểu số từ 8 đến 10 ký tự',
            'faxcongty.digits_between' => 'Fax phải là kiểu số từ 8 đến 10 ký tự',
