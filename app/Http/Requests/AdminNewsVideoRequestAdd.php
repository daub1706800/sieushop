...
class AdminNewsVideoRequestAdd extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'hinhdaidienvideo' => 'bail|required|mimes:jpeg,jpg,png|max:2048|dimensions:min_width=800, min_height=460',
            'dulieuvideotintuc' => 'bail|required|mimes:mp4,mpeg,mov,avi|max:20480',
    ...
    public function messages()
    {
        return [
            ...
            'hinhdaidienvideo.required' => 'Hình ảnh không được để trống',
            ...
            'dulieuvideotintuc.required' => 'Video không được bỏ trống',
